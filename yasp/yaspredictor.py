...
def produce_new_test(n_estimators_rf=50):
	...
	features.add_single_feature(raw_data, features.extract_string_feature_in_interval(features_list["data"],"sBase",0,4)) 
	...
	features.add_single_feature(features_test, features.extract_string_feature_in_interval(data_test,"sBase",0,4)) 
